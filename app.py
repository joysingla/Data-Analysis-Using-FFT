...
if uploaded_file1:
    ...
    fig.update_layout(title="Comparision Graph: Main and Optional File", xaxis_title="Timestamp", yaxis_title="Selected Data Column", hovermode="x", template="plotly_dark")
